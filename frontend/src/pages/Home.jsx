        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1 relative">
            ...
            <input 
              ...
              className="pl-10 border border-slate-300/80 bg-white/85 p-2.5 rounded-xl w-full focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-400 transition-all outline-none"
            />
          </div>
          ...
          <div className="md:w-48 relative">
            ...
            <select 
              ...
              className="pl-10 border border-slate-300/80 bg-white/85 p-2.5 rounded-xl w-full focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-400 transition-all appearance-none outline-none"
            >
